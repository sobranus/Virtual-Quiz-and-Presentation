...
class HandDetector:
    ...
    def findHands(self, img, draw=True, flipType=True, getBlank=False):
        """
        ...
        if self.results.multi_hand_landmarks:
            for handType, handLms in zip(self.results.multi_handedness, self.results.multi_hand_landmarks):
                ...
                if getBlank:
                    blankImg[:] = 0
                    self.mpDraw.draw_landmarks(blankImg, handLms, self.mpHands.HAND_CONNECTIONS)
...
def main():
    ...
    while True:
        ...
        if hands:
            ...
            length, info, img = detector.findDistance(lmList1[8][0:2], lmList1[12][0:2], img, color=(255, 255, 255),
                                                      scale=10)
            ...
            if len(hands) == 2:
                ...
                length, info, img = detector.findDistance(lmList1[8][0:2], lmList2[8][0:2], img, scale=10)
